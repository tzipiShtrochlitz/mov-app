            ...
            <div className="container">
              <div className="row align-items-center">
                ...
                <div className="banner-content">
                    ...
                    <a href="https://www.youtube.com/" className="banner-btn btn popup-video"  data-delay=".8s"><i className="fas fa-play" /> Watch Now</a>
              ...
              <div className="row align-items-center">
                ...
                <div className="col-lg-6">
                  ...
                  <div className="banner-content">
                    ...
                    <a href="https://www.youtube.com/" className="banner-btn btn popup-video" data-animation="fadeInUp" data-delay=".8s"><i className="fas fa-play" /> Watch Now</a>
                  </div>
