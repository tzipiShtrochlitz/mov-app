      ...
      <div className="row">
        <div className="col-xl-6 col-lg-8">
         ...
         <div className="banner-content ">
            ...
            <a href="https://www.youtube.com/" className="banner-btn btn popup-video wow fadeInUp" data-wow-delay=".8s" data-wow-duration="1.8s"><i className="fas fa-play" /> Watch Now</a>
          </div>
